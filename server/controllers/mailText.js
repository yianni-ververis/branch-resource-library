module.exports = {
  signup:{
    user:{
      ...
      html: "Hi {{username}}, thank you for joining Qlik Branch!<br /><br /><img src='http://branch-test.qlik.com/resources/branch_logo.png' align='right' height='175' width='175'/>Qlik Branch is a place for developers to learn, collaborate, and share projects with like-minded people.  <br/>To get started, why not check out our <a href='http://branch-test.qlik.com/#/project'>Projects</a> page to see the latest projects being shared in the community?  If you have a question, feel free to post it in our <a href='http://branch-test.qlik.com/#/discussion'>Forum</a> or join our public <a href='http://qlikbranch-slack-invite.herokuapp.com/'>Slack</a> channel.  You can also keep up to date with the latest news and articles in our <a href='http://branch-test.qlik.com/#/blog'>Blog section.</a><br/><br/>There is much more to come, so thanks again for joining us!<br/><br/>Nick, Alex, and Brian<br/><strong>The Qlik Branch Team</strong>"
    }
  },
  create:{
    comment:{
      ...
      html: "Hi {{parent.userid.username}},<br> There is new Activity on <strong>\"{{parent.title}}\":</strong><br/><br/>{{comment.userid.username}} said:<br/>{{comment.plaintext}}<br/><br/>Please <a href='http://branch-test.qlik.com/#/{{comment.entity}}/{{parent._id}}'>click here</a> to view the comment on Qlik Branch."
    }
  },
  unapprove:{
    userprofile:{
